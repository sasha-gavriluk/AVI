...
#------------------------------
# Виправлення 02.09.2026
#------------------------------
# Бракувало рядка `from utils.OtherUtils import _handle_error`, хоч декоратор
# @_handle_error стоїть на п'яти методах класу. Файл не імпортувався взагалі:
# NameError на етапі виконання тіла класу.
#
# Помітили не одразу, бо обидва місця, які цим класом користуються
# (WebsocketStreamer і MassiveModule), імпортують його ЛОКАЛЬНО всередині
# методів. Тому падіння траплялось би не при запуску застосунку, а вперше
# в момент підключення живого потоку даних.
