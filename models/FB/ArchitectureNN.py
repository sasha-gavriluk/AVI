...
class ArchitectureNN(nn.Module):
    "Нейромережа для класифікації Хибних Пробоїв (False Breakout). Вхід: Ковзне вікно з N свічок (OHLCV). Вихід: 2 значення від 0 до 1 (FB_Bullish, FB_Bearish)."
    ...
    def forward(self, x):
        "Прямий прохід (batch, seq_len, num_features)"
