...
class FB:
    ...
    def __init__(self):
        ...
        model_path = os.path.join(os.path.dirname(__file__), 'fb_weights.pth')
    ...
    def process(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        for idx, out in zip(indices, outputs):
            ...
            df.iloc[idx, df.columns.get_loc('FB_Bullish')] = bull_val if bull_val > 0.1 else 0.0
            df.iloc[idx, df.columns.get_loc('FB_Bearish')] = bear_val if bear_val > 0.1 else 0.0
