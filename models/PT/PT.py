...
class PT:
    ...
    def __init__(self):
        ...
        model_path = os.path.join(os.path.dirname(__file__), 'pt_weights.pth')
        ...
        self.pattern_names = [
            'PT_Hammer', 'PT_Inverted_Hammer', 'PT_Shooting_Star', 
            'PT_Engulfing_Bullish', 'PT_Engulfing_Bearish', 'PT_Morning_Star', 
            'PT_Evening_Star', 'PT_Piercing_Pattern', 'PT_Dark_Cloud_Cover', 
            'PT_Three_White_Soldiers', 'PT_Three_Black_Crows', 'PT_Hanging_Man'
        ]
