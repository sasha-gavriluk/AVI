...
# Підлягає повному рефакторингу й оновленню (буде переписана на іншому
# принципі). Ніде не імпортується (див. gui/visual/VisualRegistry.py) —
# весь код класів нижче загорнутий у рядковий літерал і не виконується,
# лишений як довідка для майбутнього переписування.
# ==================================================================

_DISABLED_TAB_CHART_VISUAL_SOURCE = r"""
import os
import pandas as pd
